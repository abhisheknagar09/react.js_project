...
const TABLE_HEAD = [
  { id: 'orderNumber', label: 'WhatappNumber' },
  { id: 'name', label: 'Webhook URL (For Receiving Messages)' },
            ...
            {STATUS_OPTIONS.map((tab) => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {['Active', 'pending', 'Inactive', 'refunded'].includes(tab.value)
...
function applyFilter({ inputData, comparator, filters, dateError }) {
  ...
  if (!dateError && startDate && endDate) {
    dataFiltered = dataFiltered.filter((item) =>
      fIsBetween(item.createdAt, startDate, endDate)
    );
  }
